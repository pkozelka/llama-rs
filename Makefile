...
# run my code
llama2-rs-run: $(LLAMA_RS) downloads/stories42M.bin downloads/llama2c-tokenizer.bin
...
llama2-c-debug: downloads/stories42M.bin downloads/llama2c-tokenizer.bin
	mkdir -p target
...
llama2-c-run: downloads/stories42M.bin downloads/llama2c-tokenizer.bin
	mkdir -p target
	gcc -Ofast -o target/llama2c-run c/llama2-run.c -lm
	target/llama2c-run downloads/stories42M.bin -z downloads/llama2c-tokenizer.bin -t 0.8 -i "One day, Lily met a Shoggoth" -s 100 -n 256
